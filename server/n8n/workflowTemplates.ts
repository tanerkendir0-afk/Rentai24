...
export const workflowTemplates: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    name: "Lead Takip E-postası",
    description: "Yeni lead oluşturulduğunda otomatik takip e-postası gönder ve CRM'de görev oluştur",
    category: "sales",
    icon: "📧",
    triggerType: "agent_tool_complete",
  ...
  },
  {
    ...
    name: "Haftalık Yönetim Raporu",
    description: "Her Pazartesi sabahı otomatik yönetim raporu oluştur ve e-posta gönder",
    category: "management",
    icon: "📊",
    triggerType: "schedule",
  ...
  },
  {
    ...
    name: "Müşteri Karşılama E-postası",
    description: "Yeni müşteri kaydolduğunda karşılama e-postası ve takip görevleri oluştur",
    category: "communication",
    icon: "🎉",
    triggerType: "agent_tool_complete",
  ...
  },
  {
    ...
    name: "İşe Alım Kontrol Listesi",
    description: "Yeni çalışan onaylandığında işe başlama kontrol listesi görevleri oluştur",
    category: "hr",
    icon: "📋",
    triggerType: "agent_tool_complete",
  ...
  },
  {
    ...
    name: "Kampanya Performans Uyarısı",
    description: "Kampanya metrikleri eşik değerin altına düştüğünde uyarı gönder",
    category: "marketing",
    icon: "📈",
  ...
  },
  {
    ...
    name: "E-posta Fatura İşleme",
    description: "Gelen e-postalardaki faturaları otomatik tespit et ve muhasebe sürecini başlat",
    category: "finance",
    icon: "📩",
